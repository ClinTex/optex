...
@:build(haxe.ui.ComponentBuilder.build("core/assets/ui/dialogs/transforms/groupby-transform-config.xml"))
class GroupByTransformConfigDialog extends TransformConfigDialog {
    public function new() {
        super();
